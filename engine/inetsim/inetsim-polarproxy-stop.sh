...
iptables -t nat -D PREROUTING -i enp0s8 -p tcp --dport 443 -j REDIRECT --to-port 10443 

# smtps           465/tcp         smtp protocol over TLS/SSL 
iptables -t nat -D PREROUTING -i enp0s8 -p tcp --dport 465 -j REDIRECT --to-port 10465

# imaps           993/tcp         imap4 protocol over TLS/SSL
iptables -t nat -D PREROUTING -i enp0s8 -p tcp --dport 993 -j REDIRECT --to-port 10993

# pop3s           995/tcp         pop3 protocol over TLS/SSL
iptables -t nat -D PREROUTING -i enp0s8 -p tcp --dport 995 -j REDIRECT --to-port 10995

# ftps            990/tcp         ftp, control, over TLS/SSL
iptables -t nat -D PREROUTING -i enp0s8 -p tcp --dport 990 -j REDIRECT --to-port 10990
